...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    await getGenres.then(res => { this.props.dispatch(saveGenres(res.data.genres)) })
    await getTrending.then(res => { this.props.dispatch(saveTrending(res.data.results)) })
    await getPopularMovies.then(res => { this.props.dispatch(saveMovies(res.data.results)) })
    await getPopularShows.then(res => { this.props.dispatch(saveShows(res.data.results)) })
